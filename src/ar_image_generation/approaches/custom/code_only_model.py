...
@dataclass(slots=True)
class ResidualCodeAROutput:
    logits: list[torch.Tensor]
    loss: torch.Tensor
    code_loss: torch.Tensor


class ResidualCodeAR(nn.Module):
    def __init__(self, cfg: ResidualCodeARConfig) -> None:
        super().__init__()
